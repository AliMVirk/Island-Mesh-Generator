...
|  F14  | Introduce a property to differentiate types of polygon tiles as "water and "land" tiles                                                       | Ali     |           |           | P      |
|  F15  | Add "lagoon tiles"                                                                                                                            | Hamza   |           |           | P      |
|  F16  | Modify tiles on the boundary to be "beach" tiles                                                                                              | Qamrosh |           |           | P      |
|  F17  | Implement command line configuration of input and output mesh                                                                                 | Ali     |           |           | P      |
